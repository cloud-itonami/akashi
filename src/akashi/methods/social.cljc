(ns akashi.methods.social
  "social.cljc — 証 — Public Ad Disclosure Transparency DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from akashi's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "証 — Public Ad Disclosure Transparency が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over akashi's own domain (kotoba-native public ad-disclosure transparency actor. Passively ingests already-public platform ad-library disclosures into kotoba EAVT…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "akashi R0: live social posting is Council Lv6+ + operator + "
