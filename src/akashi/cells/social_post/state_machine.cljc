(ns akashi.cells.social-post.state-machine
  "Phase state machine for the 証 — Public Ad Disclosure Transparency social_post cell — the publication membrane that
